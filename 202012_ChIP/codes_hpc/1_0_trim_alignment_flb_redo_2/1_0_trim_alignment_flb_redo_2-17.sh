...
fastq_untrimmed_1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR8591895_1_solidCvt.fastq
fastq_untrimmed_2=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR8591895_2_solidCvt.fastq
...
trim_fastq_end1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR8591895_1_solidCvt_val_1.fq
trim_fastq_end2=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR8591895_2_solidCvt_val_2.fq
...
sam_name=SRR8591895.sam
bowtie2 -p 16 -x $bowtie2_index -X 1000 --fr -1 $trim_fastq_end1 -2 $trim_fastq_end2 -S $sam_name

### Convert/sort/filter
bam_name=SRR8591895.bam
bam_name_srt=SRR8591895_srt.sam
sam_name_srt_dupr=SRR8591895_srt_dupr.sam
bam_name_srt_dupr=SRR8591895_srt_dupr.bam
flb_bam_name=SRR8591895_srt_dupr_flb.bam
...
echo $filesize_preFlb $filesize >> SRR8591895_bamSizes_pre_post_flb.txt
if (( filesize > 10000 )) 
then
    rm $sam_name
    rm $bam_name
