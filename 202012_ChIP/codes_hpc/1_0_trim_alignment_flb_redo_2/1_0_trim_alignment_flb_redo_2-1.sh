...
sam_name=SRR3233934.sam
bowtie2 -p 16 -x $bowtie2_index -U $trim_fastq_end1 -S $sam_name

### Convert/sort/filter
bam_name=SRR3233934.bam
bam_name_srt=SRR3233934_srt.sam
sam_name_srt_dupr=SRR3233934_srt_dupr.sam
bam_name_srt_dupr=SRR3233934_srt_dupr.bam
flb_bam_name=SRR3233934_srt_dupr_flb.bam
...
echo $filesize_preFlb $filesize >> SRR3233934_bamSizes_pre_post_flb.txt
if (( filesize > 10000 )) 
then
    rm $sam_name
    rm $bam_name
