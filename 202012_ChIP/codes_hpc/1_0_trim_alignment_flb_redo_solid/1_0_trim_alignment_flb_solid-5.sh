...
fastq_untrimmed_1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR1731131_1_solidCvt.fastq
fastqc $fastq_untrimmed_1

### Trim Galore
trim_galore --length 24 --stringency 3 $fastq_untrimmed_1
trim_fastq_end1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR1731131_1_solidCvt_trimmed.fq
...
sam_name=SRR1731131.sam
bowtie2 -p 16 -x $bowtie2_index -U $trim_fastq_end1 -S $sam_name

### Convert/sort/filter
bam_name=SRR1731131.bam
bam_name_srt=SRR1731131_srt.sam
sam_name_srt_dupr=SRR1731131_srt_dupr.sam
bam_name_srt_dupr=SRR1731131_srt_dupr.bam
flb_bam_name=SRR1731131_srt_dupr_flb.bam
...
echo $filesize_preFlb $filesize >> SRR1731131_bamSizes_pre_post_flb.txt
if (( filesize > 10000 )) 
then
    rm $sam_name
    rm $bam_name
