...
fastq_untrimmed_1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/3_0949_0182UCSD_MP1_BRD4_mm_i60.fastq
fastqc $fastq_untrimmed_1

### Trim Galore
trim_galore --length 24 --stringency 3 $fastq_untrimmed_1
trim_fastq_end1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/3_0949_0182UCSD_MP1_BRD4_mm_i60_trimmed.fq
...
sam_name=3_0949_0182UCSD_MP1_BRD4_mm_i60.sam
bowtie2 -p 16 -x $bowtie2_index -U $trim_fastq_end1 -S $sam_name

### Convert/sort/filter
bam_name=3_0949_0182UCSD_MP1_BRD4_mm_i60.bam
bam_name_srt=3_0949_0182UCSD_MP1_BRD4_mm_i60_srt.sam
sam_name_srt_dupr=3_0949_0182UCSD_MP1_BRD4_mm_i60_srt_dupr.sam
bam_name_srt_dupr=3_0949_0182UCSD_MP1_BRD4_mm_i60_srt_dupr.bam
flb_bam_name=3_0949_0182UCSD_MP1_BRD4_mm_i60_srt_dupr_flb.bam
...
echo $filesize_preFlb $filesize >> 3_0949_0182UCSD_MP1_BRD4_mm_i60_bamSizes_pre_post_flb.txt
if (( filesize > 10000 )) 
then
    rm $sam_name
    rm $bam_name
