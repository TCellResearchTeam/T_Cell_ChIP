...
########## Peak calling
macs2 callpeak -t SRR6228881_srt_dupr_flb.bam -c SRR6228882_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2018_SCIENCE_Pace_native___H3K9me3_native_invitro-d0-CD8-WT --outdir $OUT_DIR1

macs2 callpeak -t SRR6228881_srt_dupr_flb.bam -c SRR6228882_srt_dupr_flb.bam \
               -g mm --nomodel --extsize 147 --broad \
               -n 2018_SCIENCE_Pace_native___H3K9me3_native_invitro-d0-CD8-WT --outdir $OUT_DIR2
