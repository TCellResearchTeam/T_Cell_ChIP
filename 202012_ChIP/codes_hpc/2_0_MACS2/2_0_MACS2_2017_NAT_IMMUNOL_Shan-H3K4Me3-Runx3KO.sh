...
########## Peak calling
macs2 callpeak -t SRR5217323_srt_dupr_flb.bam -c SRR3586804_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2017_NAT_IMMUNOL_Shan___H3K4Me3_LCMVarmD4-P14-CD8-Runx3KO --outdir $OUT_DIR1

macs2 callpeak -t SRR5217323_srt_dupr_flb.bam -c SRR3586804_srt_dupr_flb.bam \
               -g mm --nomodel --extsize 147 --broad \
               -n 2017_NAT_IMMUNOL_Shan___H3K4Me3_LCMVarmD4-P14-CD8-Runx3KO --outdir $OUT_DIR2
