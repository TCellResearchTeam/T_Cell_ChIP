...
########## Peak calling
macs2 callpeak -t SRR1124799_srt_dupr_flb.bam -c SRR1124815_srt_dupr_flb.bam SRR1124816_srt_dupr_flb.bam SRR1124817_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2014_NAT_IMMUNOL_Kurachi___cJun-invitro-d3-CD8 --outdir $OUT_DIR1
