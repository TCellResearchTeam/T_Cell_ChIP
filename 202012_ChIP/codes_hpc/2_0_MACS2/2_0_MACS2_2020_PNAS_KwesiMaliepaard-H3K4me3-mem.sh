...
########## Peak calling
macs2 callpeak -t SRR10285317_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2020_PNAS_KwesiMaliepaard___H3K4me3_mem-CD8 --outdir $OUT_DIR1

macs2 callpeak -t SRR10285317_srt_dupr_flb.bam \
               -g mm --nomodel --extsize 147 --broad \
               -n 2020_PNAS_KwesiMaliepaard___H3K4me3_mem-CD8 --outdir $OUT_DIR2
