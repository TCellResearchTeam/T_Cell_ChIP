...
########## Peak calling
macs2 callpeak -t SRR5905846_srt_dupr_flb.bam -c SRR5905836_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2017_PNAS_Li___H3K27Ac_IL2-CD4 --outdir $OUT_DIR1

macs2 callpeak -t SRR5905846_srt_dupr_flb.bam -c SRR5905836_srt_dupr_flb.bam \
               -g mm --nomodel --extsize 147 --broad \
               -n 2017_PNAS_Li___H3K27Ac_IL2-CD4 --outdir $OUT_DIR2
