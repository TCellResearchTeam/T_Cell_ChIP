...
########## Peak calling
macs2 callpeak -t SRR6228887_srt_dupr_flb.bam -c SRR6228888_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2018_SCIENCE_Pace_native___H3K9me3_invitro-d3-CD8-Suv39h1KO --outdir $OUT_DIR1

macs2 callpeak -t SRR6228887_srt_dupr_flb.bam -c SRR6228888_srt_dupr_flb.bam \
               -g mm --nomodel --extsize 147 --broad \
               -n 2018_SCIENCE_Pace_native___H3K9me3_invitro-d3-CD8-Suv39h1KO --outdir $OUT_DIR2
