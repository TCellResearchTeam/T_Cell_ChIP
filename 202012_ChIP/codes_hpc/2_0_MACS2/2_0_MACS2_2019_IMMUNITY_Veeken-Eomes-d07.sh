...
########## Peak calling
macs2 callpeak -t SRR8591891_srt_dupr_flb.bam SRR8591892_srt_dupr_flb.bam SRR8591893_srt_dupr_flb.bam -c SRR8591894_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2019_IMMUNITY_Veeken___Eomes_LCMV-d07-CD8 --outdir $OUT_DIR1
