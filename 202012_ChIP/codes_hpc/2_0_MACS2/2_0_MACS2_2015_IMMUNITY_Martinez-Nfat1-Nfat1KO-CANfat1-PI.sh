...
########## Peak calling
macs2 callpeak -t SRR1731137_srt_dupr_flb.bam -c SRR1731131_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2015_IMMUNITY_Martinez___Nfat1_invitro-CD8-PI-1h-Nfat1KO-CA-RIT-RV --outdir $OUT_DIR1
