...
########## Peak calling
macs2 callpeak -t SRR10285315_srt_dupr_flb.bam SRR10285316_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2020_PNAS_KwesiMaliepaard___H3K79me2_mem-CD8 --outdir $OUT_DIR1

macs2 callpeak -t SRR10285315_srt_dupr_flb.bam SRR10285316_srt_dupr_flb.bam \
               -g mm --nomodel --extsize 147 --broad \
               -n 2020_PNAS_KwesiMaliepaard___H3K79me2_mem-CD8 --outdir $OUT_DIR2
