...
########## Peak calling
macs2 callpeak -t SRR2075569_srt_dupr_flb.bam SRR2075570_srt_dupr_flb.bam -c SRR2075586_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2015_JEM_Dominguez___Tbet_LCMVarm-D8-CD8-Zeb2KO --outdir $OUT_DIR1
