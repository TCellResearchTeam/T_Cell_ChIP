...
########## Peak calling
macs2 callpeak -t SRR8591880_srt_dupr_flb.bam SRR8591881_srt_dupr_flb.bam SRR8591882_srt_dupr_flb.bam SRR8591883_srt_dupr_flb.bam -c SRR8591884_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2019_IMMUNITY_Veeken___Cbfb_NAV-CD8 --outdir $OUT_DIR1
