...
########## Peak calling
macs2 callpeak -t SRR8591895_srt_dupr_flb.bam SRR8591896_srt_dupr_flb.bam -c SRR8591897_srt_dupr_flb.bam \
               -g mm -B --SPMR --nomodel --extsize 147 --call-summits \
               -n 2019_IMMUNITY_Veeken___Tbet_LCMV-d07-CD8 --outdir $OUT_DIR1
