...
bdg_name=$MACS2_DIR/2013_IMMUNITY_KIM___Foxo1_Biotin_naive-CD8-WT_treat_pileup.bdg
bdg_srt_name=$MACS2_DIR/2013_IMMUNITY_KIM___Foxo1_Biotin_naive-CD8-WT_treat_pileup_srt.bdg
bw_name=$OUT_DIR/2013_IMMUNITY_KIM___Foxo1_Biotin_naive-CD8-WT.bw
