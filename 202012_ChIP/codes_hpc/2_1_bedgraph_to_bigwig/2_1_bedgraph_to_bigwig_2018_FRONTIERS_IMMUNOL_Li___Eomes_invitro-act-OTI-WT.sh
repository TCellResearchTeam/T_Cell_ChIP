...
bdg_name=$MACS2_DIR/2018_FRONTIERS_IMMUNOL_Li___Eomes_invitro-act-OTI-WT_treat_pileup.bdg
bdg_srt_name=$MACS2_DIR/2018_FRONTIERS_IMMUNOL_Li___Eomes_invitro-act-OTI-WT_treat_pileup_srt.bdg
bw_name=$OUT_DIR/2018_FRONTIERS_IMMUNOL_Li___Eomes_invitro-act-OTI-WT.bw
