...
bdg_name=$MACS2_DIR/2018_IMMUNITY_Page___Tox_LCMVova_CNS-OTI-CD8-WT_treat_pileup.bdg
bdg_srt_name=$MACS2_DIR/2018_IMMUNITY_Page___Tox_LCMVova_CNS-OTI-CD8-WT_treat_pileup_srt.bdg
bw_name=$OUT_DIR/2018_IMMUNITY_Page___Tox_LCMVova_CNS-OTI-CD8-WT.bw
