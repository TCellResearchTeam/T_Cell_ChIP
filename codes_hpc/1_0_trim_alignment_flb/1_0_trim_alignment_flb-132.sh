...
fastq_untrimmed_1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR5905846_1.fastq
fastqc $fastq_untrimmed_1

### Trim Galore
trim_galore --length 24 --stringency 3 $fastq_untrimmed_1
trim_fastq_end1=/gpfs/group/pipkin/hdiao/T_Cell_ChIP/0_fastq/SRR5905846_1_val_1.fq
...
sam_name=SRR5905846.sam
bowtie2 -p 16 -x $bowtie2_index -U $trim_fastq_end1 -S $sam_name

### Convert/sort/filter
bam_name=SRR5905846.bam
bam_name_srt=SRR5905846_srt.sam
sam_name_srt_dupr=SRR5905846_srt_dupr.sam
bam_name_srt_dupr=SRR5905846_srt_dupr.bam
flb_bam_name=SRR5905846_srt_dupr_flb.bam
